...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
    {
        ...
        {
            TweenerCore<Color, Color, ColorOptions> t = DOTween.ToAlpha(() => target.OutlineColor, x => target.OutlineColor = x, endValue, duration);
            t.SetTarget(target);
            return t;
        }
        ...
        //{
        //    TweenerCore<Vector2, Vector2, VectorOptions> t = DOTween.To(() => target.OutlineWidth , x => target.OutlineWidth = x, endValue, duration);
        //    t.SetTarget(target);
        //    return t;
        //}
